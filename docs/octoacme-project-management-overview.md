...
> See [Roles & Personas](octoacme-roles-and-personas.md) for full descriptions and the [Project Roles Checklist](octoacme-project-roles-checklist.md) for phase-by-phase engagement guidance.
